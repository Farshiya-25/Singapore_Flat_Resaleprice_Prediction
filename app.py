...
df1 = pd.read_csv('data/ResaleFlatPricesBasedonApprovalDate19901999.csv')
df2 = pd.read_csv('data/ResaleFlatPricesBasedonApprovalDate2000Feb2012.csv')
df3 = pd.read_csv('data/ResaleFlatPricesBasedonRegistrationDateFromMar2012toDec2014.csv')
df4 = pd.read_csv('data/ResaleFlatPricesBasedonRegistrationDateFromJan2015toDec2016.csv')
df5 = pd.read_csv('data/ResaleflatpricesbasedonregistrationdatefromJan2017onwards.csv')
...
with page1:
    ...
    if submitted:
        try:
            ...
            with open("models/Resaleprice_1.pkl","rb") as ft:
